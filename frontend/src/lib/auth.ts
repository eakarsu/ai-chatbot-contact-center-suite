export const AUTH_COOKIE = 'ai_chatbot_contact_center_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-contact-center.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-contact-center.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-contact-center.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
