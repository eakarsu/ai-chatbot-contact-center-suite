...
const featureSeeds = [
  ...
  ["conversation-console","Conversation Console","Conversation Console workspace","Contact Center Operations","Review source evidence and assign owner"],
  ["handoff-queue","Handoff Queue","Handoff Queue workspace","Contact Center Operations","Confirm findings, next action, and audit evidence"],
  ["knowledge-grounding","Knowledge Grounding","Knowledge Grounding workspace","Contact Center Operations","Confirm findings, next action, and audit evidence"],
  ["qa-scoring","QA Scoring","QA Scoring workspace","Contact Center Operations","Confirm findings, next action, and audit evidence"],
  ["intent-analytics","Intent Analytics","Intent Analytics workspace","Contact Center Operations","Confirm findings, next action, and audit evidence"],
