...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI Chatbot Contact Center Suite Dashboard"
      subtitle="One merged ai chatbot contact center view for Chatbots, Knowledge Base, Conversations, Live Handoff, Ticket Triage, WhatsApp/Web Chat, Intents, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai chatbot contact center jobs into one surface. Chatbots, Knowledge Base, Conversations, Live Handoff, Ticket Triage, WhatsApp/Web Chat, Intents, source tables, documents, audit, and AI are presented as platform features.
          </div>
